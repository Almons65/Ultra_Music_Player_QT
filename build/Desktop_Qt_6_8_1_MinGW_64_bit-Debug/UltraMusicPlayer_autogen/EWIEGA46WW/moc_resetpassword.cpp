...
static constexpr auto qt_meta_stringdata_ZN13ResetPasswordE = QtMocHelpers::stringData(
    "ResetPassword"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ResetPasswordE[] = {
...
Q_CONSTINIT const QMetaObject ResetPassword::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ResetPasswordE.offsetsAndSizes,
    qt_meta_data_ZN13ResetPasswordE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ResetPasswordE_t,
        // Q_OBJECT / Q_GADGET
...
void *ResetPassword::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ResetPasswordE.stringdata0))
